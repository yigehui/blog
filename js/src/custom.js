...
$("figure").hover(
    function() {
        ...
        $(this).css("position","relative");
         if(!$(this).find("#copyBtn").length){
            $copyBtn.remove();
            $(this).append('<div id="copyBtn" style="position: absolute;top:14px; opacity:0.8; cursor:pointer;right:5px;display: block;line-height: 1; font-size:1.5em"><span id="imgCopy" ><i class="fa fa-paste fa-fw"></i></span>');
         }else{
            $copyBtn.stop();
    ...
    function() {
        ...
        $("#copyBtn").animate({opacity:0},1000);
    }
);
//页面载入完成后，创建复制按钮
